...
/**
 * Provider setup per RFC:
 *
 *   <QueryClientProvider>
 *     <WagmiProvider>
 *       <MiniKitProvider>     ← auto-detects Wagmi from tree above
 *         {children}
 *       </MiniKitProvider>
 *     </WagmiProvider>
 *   </QueryClientProvider>
 *
 * No manual configureWagmi() needed — MiniKitProvider reads the Wagmi
 * config from WagmiProvider's context automatically.
 */
