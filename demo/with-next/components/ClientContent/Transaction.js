...
export const SendTransaction = () => {
  ...
  return _jsxs('div', {
    ...
    children: [
      ...
      _jsx('div', {
        className: 'bg-gray-50 border-l-4 border-gray-400 p-4 mb-4',
        children: _jsxs('div', {
          className: 'flex',
          children: [
            _jsx('div', {
            ...
            _jsx('div', {
              ...
              children: _jsxs('p', {
                ...
                children: [
                  ...
                  ' Green buttons should always work, red should fail, and black works if the conditions are met.',
                ],
              }),
            }),
          ],
      ...
      _jsxs('div', {
        ...
        children: [
          _jsx('p', { children: 'Raw string:' }),
          _jsx('div', {
            className: 'bg-gray-300 min-h-[100px] p-2',
            children: _jsx('pre', {
              className:
                'break-all whitespace-break-spaces max-h-[300px] overflow-y-scroll',
      ...
      _jsx('div', {
        ...
        children: _jsx('button', {
          ...
          children: 'No preview just response',
        }),
      }),
      _jsxs('div', {
        className: 'grid gap-x-2 grid-cols-2',
        children: [
          _jsx('button', {
            ...
            children: 'Non Existant Function',
          }),
          _jsx('button', {
            className: 'bg-red-700 text-white rounded-lg p-4 w-full',
            onClick: intentionallyRevert,
            children: 'Intentionally Revert',
          }),
        ],
      }),
      _jsxs('div', {
        ...
        children: [
          _jsx('button', {
            ...
            children: 'Permit 2 Testing (0.1 USDC)',
          }),
          _jsx('button', {
            className: 'bg-black text-white rounded-lg p-4 w-full',
            onClick: onSendNestedTransactionClick,
            children: 'Nested Transaction (0.3 USDC)',
          }),
        ],
      }),
      _jsxs('div', {
        ...
        children: [
          ...
          _jsx('button', {
            ...
            children: 'Purchase NFT Permit2 (0.1 USDC)',
          }),
        ],
      }),
      _jsxs('div', {
        ...
        children: [
          ...
          _jsx('div', {
            ...
            children: _jsx('pre', {
              ...
              children: JSON.stringify(receivedSendTransactionPayload, null, 2),
            }),
          }),
          _jsxs('div', {
            className: 'grid gap-y-1',
          ...
          _jsxs('div', {
            ...
            children: [
              ...
              _jsxs('div', {
                className: 'grid gap-y-1 bg-gray-300 p-2',
                children: [
                  transactionId &&
                    _jsxs('p', {
                      children: ['Transaction ID: ', transactionId],
                    }),
                  isConfirming &&
                    _jsx('p', { children: 'Waiting for confirmation...' }),
                  isConfirmed &&
                    _jsx('p', { children: 'Transaction confirmed.' }),
                  isError && _jsx('p', { children: error?.message }),
                ],
              }),
            ],
          }),
