...
export const parseSiweMessage = (inputString) => {
...
export const generateSiweMessage = (siweMessageData) => {
  let siweMessage = '';
...
const validateMessage = (siweMessageData, nonce, statement, requestId) => {
